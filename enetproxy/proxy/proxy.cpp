...
void serverdata() {
    try
    {
        http::Request serverdata{ "http://a104-125-3-135.deploy.static.akamaitechnologies.com/growtopia/server_data.php" };
...
int main() {
    ...
    serverdata();
    edithost();
    std::thread http(http::run, "127.0.0.1", "443"); //"17191"
    http.detach();
